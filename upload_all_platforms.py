"""
Velocity Telugu - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_english", "Telugu Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   {phrase.get('telugu', '')}")
        ...
        caption_lines.extend([
            ...
            f"Follow for daily Telugu lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category, phrases=None):
    ...
    print("\n" + "="*80)
    print("VELOCITY TELUGU - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("VELOCITY TELUGU - AUTOMATED UPLOAD")
    print("="*80)
